...
You can change the logo at the top-left corner of the header navbar, and the icon of your webpage in the browser tab.
...
* :file_folder: `/public` folder contains some images.

## Update BlogiNote
Stay tuned for the **version** of BlogiNote at [the homepage in npm](https://www.npmjs.com/package/bloginote).
