...
* inline code: the code inside the paragraph, writing inline code between the **backquote**
    ...
    :hammer: compiled to web page you will get the result like that :point_right: Markdown file extension name is `.md`
...
* block code: the code show as a block, writing block code between **three backquote**
    ...
    :hammer: compiled to web page you will get the final result as below :point_down:
