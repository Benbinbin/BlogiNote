...
* If you choose the `Create new file` option
    ...
    ::TipBox{type="tip"}
    You can click the [:IconCustom{name="octicon:eye-24" iconClass="w-4 h-4"} Preview]{.p-1 .text-xs .text-gray-600 .hover:bg-gray-100 .border .border-gray-300 .rounded .transition-colors .duration-300 .cursor-pointer} tab to preview the markdown file
    ::
...
At the bottom of this page, there's **a dialog called `Commit changes`**, you should write a title and description for this action, the default `add articles` then click the [Commit changes]{.px-2.5 .py-1.5 .text-sm .text-white .font-bold .bg-green-500 .hover:bg-green-600 .rounded .transition-colors .duration-300 .cursor-pointer}
