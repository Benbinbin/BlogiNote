...
The RSS feed and sitemap will generate automatically, The only things you need to do is providing some metadata of your website at `nuxt.config.ts` for generating the correct RSS feed.
